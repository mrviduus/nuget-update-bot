...
Create `nuget-update-bot.json` in your project root:
...
```bash
export NUGET_BOT_DefaultPolicy=patch
export NUGET_BOT_IncludePrerelease=true
export NUGET_BOT_TimeoutSeconds=60
```
