...
- [ ] T001 Create NugetUpdateBot project structure per implementation plan
- [ ] T002 [P] Create NugetUpdateBot.csproj with .NET 8 target and required packages
- [ ] T003 [P] Create NugetUpdateBot.Tests.csproj with xUnit and Moq references
- [ ] T004 [P] Add .editorconfig for code style consistency
- [ ] T005 [P] Create .gitignore for .NET projects
- [ ] T006 Setup Program.cs with top-level statements and minimal structure

## Phase 2: Foundational (Core Infrastructure)

**Purpose**: Shared components needed by all user stories

- [ ] T007 Define core records in Program.cs (PackageReference, UpdateCandidate, UpdateRule)
- [ ] T008 Define enums in Program.cs (UpdateType, UpdatePolicy, OutputFormat)
- [ ] T009 Implement NuGet repository connection setup using NuGet.Protocol
- [ ] T010 Create System.CommandLine root command structure with help text
- [ ] T011 Implement error handling constants and exit codes
- [ ] T012 Create configuration record (BotConfiguration) with default values
- [ ] T013 Implement configuration loading from JSON file and environment variables
- [ ] T014 Add SemaphoreSlim(5) throttling for parallel API calls
- [ ] T015 Setup SourceCacheContext for API response caching
...
- [ ] T016 [P] [US1] Write unit test for project file parsing in NugetUpdateBot.Tests/UnitTests/PackageScannerTests.cs
- [ ] T017 [P] [US1] Write unit test for version comparison logic in NugetUpdateBot.Tests/UnitTests/VersionComparerTests.cs
- [ ] T018 [P] [US1] Write integration test for NuGet API queries in NugetUpdateBot.Tests/IntegrationTests/NuGetApiTests.cs
- [ ] T019 [P] [US1] Write test for scan command output formatting in NugetUpdateBot.Tests/UnitTests/OutputFormatterTests.cs

### Implementation for User Story 1

- [ ] T020 [US1] Implement project file XML parsing using System.Xml.Linq in Program.cs
- [ ] T021 [US1] Extract PackageReference entries from project file in Program.cs
- [ ] T022 [US1] Implement GetAllVersionsAsync method using FindPackageByIdResource in Program.cs
- [ ] T023 [US1] Create version comparison logic using NuGetVersion in Program.cs
- [ ] T024 [US1] Implement CheckPackageAsync method with throttling in Program.cs
- [ ] T025 [US1] Create scan command with options (--project, --include-prerelease, --verbose, --no-cache) in Program.cs
- [ ] T026 [US1] Implement console output formatter for scan results in Program.cs
- [ ] T027 [US1] Add error handling for file not found and network errors in Program.cs
- [ ] T028 [US1] Connect scan command handler to package checking logic in Program.cs
- [ ] T029 [US1] Verify all US1 tests pass and scan command works end-to-end
...
- [ ] T030 [P] [US2] Write unit test for project file modification in NugetUpdateBot.Tests/UnitTests/UpdateServiceTests.cs
- [ ] T031 [P] [US2] Write test for update policy application in NugetUpdateBot.Tests/UnitTests/UpdatePolicyTests.cs
- [ ] T032 [P] [US2] Write test for dry-run mode in NugetUpdateBot.Tests/UnitTests/DryRunTests.cs
- [ ] T033 [P] [US2] Write integration test for file operations in NugetUpdateBot.Tests/IntegrationTests/FileOperationTests.cs

### Implementation for User Story 2

- [ ] T034 [US2] Implement project file backup mechanism before modifications in Program.cs
- [ ] T035 [US2] Create UpdatePackageVersion method preserving XML formatting in Program.cs
- [ ] T036 [US2] Implement update policy logic (Major/Minor/Patch restrictions) in Program.cs
- [ ] T037 [US2] Add package exclusion filtering logic in Program.cs
- [ ] T038 [US2] Create update command with options (--dry-run, --exclude, --policy) in Program.cs
- [ ] T039 [US2] Implement dry-run preview functionality in Program.cs
- [ ] T040 [US2] Add project file validation after modifications in Program.cs
- [ ] T041 [US2] Connect update command handler to modification logic in Program.cs
- [ ] T042 [US2] Verify all US2 tests pass and update command works with dry-run
